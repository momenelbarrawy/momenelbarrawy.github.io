...
![a](/portswigger/Authebtication/imagesforUsername%20enumeration%20via%20different%20responsess/1.png)  

![a](/portswigger/Authebtication/imagesforUsername%20enumeration%20via%20different%20responsess/2.png)  
...
![a](/portswigger/Authebtication/imagesforUsername%20enumeration%20via%20different%20responsess/3.png)  

---

2. Configure a **Sniper attack** → Set the username value → Load payloads from the username list → Start the attack:  
![a](/portswigger/Authebtication/imagesforUsername%20enumeration%20via%20different%20responsess/4.png)  

---

3. All status codes are **200**. However, if we compare response lengths, we can see only one with a different length:  
![a](/portswigger/Authebtication/imagesforUsername%20enumeration%20via%20different%20responsess/5.png)  

The response:  
![a](/portswigger/Authebtication/imagesforUsername%20enumeration%20via%20different%20responsess/9.png)  
...
![a](/portswigger/Authebtication/imagesforUsername%20enumeration%20via%20different%20responsess/6.png)  

---

2. Filter results by **status code**:  
![a](/portswigger/Authebtication/imagesforUsername%20enumeration%20via%20different%20responsess/7.png)  
...
![a](/portswigger/Authebtication/imagesforUsername%20enumeration%20via%20different%20responsess/8.png)
