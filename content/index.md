...
## About Me
![Hacker Gif](https://media.giphy.com/media/HoffxyN8ghVuw/giphy.gif)  
I am a cybersecurity engineer passionate about **offensive security**, **penetration testing**, and **secure web development**.  
I thrive on breaking systems to make them stronger, and I constantly sharpen my skills through **CTF challenges**, **labs**, and **real-world testing scenarios**.  

---

## Skills

**Operating Systems:** Kali Linux, Arch Linux, Windows  
**Programming:** C, C++, Bash, Java  
**Security Tools:** Nmap, Wireshark, Burp Suite, Metasploit, John the Ripper  
**Cybersecurity:** Vulnerability Assessment, Network Security, OWASP Top 10, Secure Coding, Digital Forensics, SIEM, ISO 27001  
**Web Technologies:** PHP, MySQL, HTML, Spring Boot  
**DevOps:** Git, GitHub Actions, Docker (Basics)  

### Tool Badges
![Kali Linux](https://img.shields.io/badge/Kali%20Linux-557C94?style=for-the-badge&logo=kali-linux&logoColor=white)  
![Nmap](https://img.shields.io/badge/Nmap-004C99?style=for-the-badge&logo=security&logoColor=white)  
...
## Certifications
![JPT Badge](https://img.shields.io/badge/eLearnSecurity-JPTv1-FF0000?style=for-the-badge)  
![OSCP Badge](https://img.shields.io/badge/OSCP-In%20Progress-orange?style=for-the-badge)  

- eLearnSecurity Junior Penetration Tester (JPT v1) – Completed  
- Offensive Security Certified Professional (OSCP) – In Progress  
- Cybersecurity Training – Egyptian Digital Platform for Investment (DEPI)  
  Topics: Network Security, Secure Coding, Digital Forensics, Cyber Risk Management, SIEM, Cybersecurity Compliance (ISO 27001)
...
![Survey Screenshot](https://via.placeholder.com/600x300.png?text=Online+Survey+Builder)  
Secure survey creation & management platform with role-based access control.  
Tech: Spring Boot, MySQL  

**Shipping Website**  
![Shipping Screenshot](https://via.placeholder.com/600x300.png?text=Shipping+Website)  
Logistics portal with admin & customer dashboards, tracking system.  
Tech: PHP, MySQL  
...
## Contact
**Location:** Giza, Egypt  
**Email:** momenelbarrawy@gmail.com  
